        ...
        <div>
            ...
            <Container>
                <form onSubmit={ e => { e.preventDefault(); }}>
                    <select size="10" value={valgtButikk} onChange={e => dispatch(VELG_BUTIKK(butikker.find(b => b.storeId.toString()===e.target.value) || uvalgtButikk))}>
                    ...
                    <div>
                        <div>&nbsp;</div>
                        <button onClick={onLagreEndretButikkClicked}>Lagre endret butikk</button>
                    </div>
                </form>
            </Container>
        </div>
